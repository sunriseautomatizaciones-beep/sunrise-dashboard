...
export default function AgentesPage() {
  ...
  return (
    <div className="flex h-full overflow-hidden">
      ...
      <div className="w-52 flex-shrink-0 bg-[#1E293B] border-r border-[#334155] flex flex-col">
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        {/* Chat header */}
        <div className="px-6 py-4 border-b border-[#334155] bg-[#0F172A] flex items-center justify-between flex-shrink-0">
